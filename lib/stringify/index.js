...
visitors.block = require('./visitors/block')

visitors.root = require('./visitors/root')

visitors.heading = require('./visitors/heading')

visitors.text = require('./visitors/text')

visitors.paragraph = require('./visitors/paragraph')

visitors.blockquote = require('./visitors/blockquote')

visitors.list = require('./visitors/list')

visitors.inlineCode = require('./visitors/inline-code')

visitors.yaml = require('./visitors/yaml')

visitors.code = require('./visitors/code')

visitors.html = require('./visitors/html')

visitors.thematicBreak = require('./visitors/thematic-break')

visitors.strong = require('./visitors/strong')

visitors.emphasis = require('./visitors/emphasis')

visitors.break = require('./visitors/break')

visitors.delete = require('./visitors/delete')

visitors.link = require('./visitors/link')

visitors.linkReference = require('./visitors/link-reference')

visitors.imageReference = require('./visitors/image-reference')

visitors.footnoteReference = require('./visitors/footnote-reference')

visitors.definition = require('./visitors/definition')

visitors.image = require('./visitors/image')

visitors.footnote = require('./visitors/footnote')

visitors.footnoteDefinition = require('./visitors/footnote-definition')

visitors.table = require('./visitors/table')

visitors.tableCell = require('./visitors/table-cell')
...
compilerPrototype.visit = function (node, parent) {
  ...
  return visitors[node.type](self, node, parent)
}
