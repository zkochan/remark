 ...
 *   `Parser#setOptions()`.
 */
function parserFactory (file, options, processor) {
  /*
  ...
  const parser = {
     ...
     */
    parse () {
      const value = clean(String(parser.file))
      ...
      return parser.tokenizeBlock(value)
        .then(children => {
          ...
          node.position.end = parser.eof || extend({}, node.position.start)
    ...
    blockTokenizers: [
      {
        ...
        func: require('./block-tokenizers/yaml-front-matter'),
      },
      {
        name: 'newline',
        func: require('./block-tokenizers/new-line'),
      },
      {
        name: 'code',
        func: require('./block-tokenizers/code'),
      },
      {
        name: 'fences',
        func: require('./block-tokenizers/fences'),
      },
      {
        name: 'heading',
        func: require('./block-tokenizers/heading'),
      },
      {
        name: 'lineHeading',
        func: require('./block-tokenizers/line-heading'),
      },
      {
        name: 'thematicBreak',
        func: require('./block-tokenizers/thematic-break'),
      },
      {
        name: 'blockquote',
        func: require('./block-tokenizers/blockquote'),
      },
      {
        name: 'list',
        func: require('./block-tokenizers/list'),
      },
      {
        name: 'html',
        func: require('./block-tokenizers/html'),
      },
      {
        name: 'definition',
        func: require('./block-tokenizers/definition'),
      },
      {
        name: 'footnoteDefinition',
        func: require('./block-tokenizers/footnote'),
      },
      {
        name: 'table',
        func: require('./block-tokenizers/table'),
      },
      {
        name: 'paragraph',
        func: require('./block-tokenizers/paragraph'),
      },
    ],
    ...
    inlineTokenizers: [
      {
        name: 'escape',
        func: require('./inline-tokenizers/escape'),
      },
      {
        name: 'autoLink',
        func: require('./inline-tokenizers/auto-link'),
      },
      {
        name: 'url',
        func: require('./inline-tokenizers/url'),
      },
      {
        name: 'tag',
        func: require('./inline-tokenizers/tag'),
      },
      {
        name: 'link',
        func: require('./inline-tokenizers/link'),
      },
      {
        name: 'reference',
        func: require('./inline-tokenizers/reference'),
      },
      {
        name: 'strong',
        func: require('./inline-tokenizers/strong'),
      },
      {
        name: 'emphasis',
        func: require('./inline-tokenizers/emphasis'),
      },
      {
        name: 'deletion',
        func: require('./inline-tokenizers/deletion'),
      },
      {
        name: 'inlineCode',
        func: require('./inline-tokenizers/code'),
      },
      {
        name: 'break',
        func: require('./inline-tokenizers/break'),
      },
      {
        name: 'inlineText',
        func: require('./inline-tokenizers/text'),
      },
    ],

    file,
    data: processor.data,
    toOffset: vfileLocation(file).toOffset,
